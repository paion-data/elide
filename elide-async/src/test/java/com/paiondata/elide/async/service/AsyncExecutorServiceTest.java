...
public class AsyncExecutorServiceTest {
    ...
    public void setupMockElide() {
        ...
        elide = new Elide(
                ElideSettings.builder().dataStore(inMemoryStore)
                        ...
                        .build());
        asyncApiDao = Mockito.mock(DefaultAsyncApiDao.class);
        testUser = mock(User.class);
        scope = mock(RequestScope.class);
        resultStorageEngine = Mockito.mock(FileResultStorageEngine.class);
    ...
    public void testAsyncExecutorServiceSet() {
        ...
        Assertions.assertEquals(asyncApiDao, service.getAsyncApiDao());

...
public class ExportApiEndpointTest {
    ...
    private ExportApiEndpoint.ExportApiProperties exportApiProperties;
    private ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);

    @BeforeEach
    public void setup() {
        engine = Mockito.mock(FileResultStorageEngine.class);
    ...
    public void testGet() {
        ...
        exportApiProperties = new ExportApiEndpoint.ExportApiProperties(Executors.newFixedThreadPool(1), Duration.ofSeconds(maxDownloadTimeSeconds));

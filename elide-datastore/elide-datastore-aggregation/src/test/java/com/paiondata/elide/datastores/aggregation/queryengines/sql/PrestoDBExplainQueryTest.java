...
public class PrestoDBExplainQueryTest extends SQLUnitTest {
    ...
    */
    ...
    public void testNestedMetricQuery() {
        ...
        String exptectedQueryStr = getExpectedNestedMetricQuery().replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
    ...
    public void testNestedMetricWithHavingQuery() {
        ...
        String exptectedQueryStr = getExpectedNestedMetricWithHavingQuery().replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
    ...
    public void testNestedMetricWithWhereQuery() {
        ...
        String exptectedQueryStr = getExpectedNestedMetricWithWhereQuery().replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
    ...
    public void testNestedMetricWithSortingQuery() {
        ...
        String exptectedQueryStr = getExpectedNestedMetricWithSortingQuery(true).replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
    ...
    public void testNestedMetricWithAliasesQuery() {
        ...
        String expectedStr = getExpectedNestedMetricWithAliasesSQL(true).replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
    ...
    public void testWhereWithArguments() {
        ...
        String expectedStr = getExpectedWhereWithArgumentsSQL().replace(AbstractSqlDialect.BACKTICK, AbstractSqlDialect.DOUBLE_QUOTE);
        assertEquals(expectedStr, queryStr);
    }

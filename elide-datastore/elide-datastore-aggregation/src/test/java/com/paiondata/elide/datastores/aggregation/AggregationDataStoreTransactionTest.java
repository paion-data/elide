...
class AggregationDataStoreTransactionTest extends SQLUnitTest {
    ...
    public void testMissingRequiredTableFilter() {
        ...
        Table table = new SQLTable(new Namespace(NamespacePackage.DEFAULT_NAMESPACE),
    ...
    public void testRequiredTableFilterArguments() throws Exception {
        ...
        SQLTable table = new SQLTable(new Namespace(NamespacePackage.DEFAULT_NAMESPACE), tableType, dictionary);

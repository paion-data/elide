...
public class JsonApiDSLTest {
    ...
    public void verifyPatchOperation() {
        ...
        String actual = JsonApiDSL.patchSet(
                JsonApiDSL.patchOperation(PatchOperationType.add, "/parent",
                        JsonApiDSL.resource(
                ...
                JsonApiDSL.patchOperation(PatchOperationType.add, "/parent/1/children",
                        JsonApiDSL.resource(
    ...
    void verifyAtomicOperationData() {
        ...
        String actual = JsonApiDSL.atomicOperations(
                JsonApiDSL.atomicOperation(AtomicOperationCode.add,
                        JsonApiDSL.datum(JsonApiDSL.resource(
                                JsonApiDSL.type("article"),
                                JsonApiDSL.id("13"),
                                JsonApiDSL.attributes(
                                        JsonApiDSL.attr("name", "article")
                                )
                        ))
                )
                ).toJSON();
        ...
        String actual = JsonApiDSL.atomicOperations(
                JsonApiDSL.atomicOperation(AtomicOperationCode.add,
                        JsonApiDSL.datum(JsonApiDSL.resource(
                                ...
                                JsonApiDSL.relationships(JsonApiDSL.relation("post", true,
                                        JsonApiDSL.links(
                                        JsonApiDSL.attr("self",
                                                "https://elide.io/"
                                                        + "group/com.example.repository2/relationships/products"),
                                        JsonApiDSL.attr("related", "https://elide.io/" + "group/com.example.repository2/products"))
                                ...
                                JsonApiDSL.relationships(JsonApiDSL.relation("post", true,
                                        ...
                                        JsonApiDSL.attr("self",
                                                "https://elide.io/"
                                                        + "group/com.example.repository2/relationships/products"),
                                        JsonApiDSL.attr("related", "https://elide.io/" + "group/com.example.repository2/products")),
                                        JsonApiDSL.linkage(JsonApiDSL.type("group"), JsonApiDSL.id("2"))

...
public class JpaDataStoreRegistrations {
    ...
    public static JpaDataStoreRegistration buildJpaDataStoreRegistration(String entityManagerFactoryName,
        ...
        JpaDataStore.JpaTransactionSupplier writeJpaTransactionSupplier = buildJpaTransactionSupplier(platformTransactionManager,
     ...
     */
    public static JpaDataStore.JpaTransactionSupplier buildJpaTransactionSupplier(PlatformTransactionManager transactionManager,

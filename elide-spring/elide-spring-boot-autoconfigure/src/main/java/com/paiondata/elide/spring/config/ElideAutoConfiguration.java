...
public class ElideAutoConfiguration {
    ...
    /**
     * Creates the {@link ElideSettings.ElideSettingsBuilder}.
     * <p>
    ...
    public ElideSettings.ElideSettingsBuilder elideSettingsBuilder(ElideConfigProperties settings, EntityDictionary entityDictionary,
                                                                   DataStore dataStore, HeaderProcessor headerProcessor, ElideMapper elideMapper, AuditLogger auditLogger,
                                                                   Serdes.SerdesBuilder serdesBuilder, ObjectProvider<Settings.SettingsBuilder> settingsProvider,
    ...
    /**
     * Creates the {@link Serdes.SerdesBuilder}.
     * <p>
    ...
    public Serdes.SerdesBuilder serdesBuilder(ObjectProvider<SerdesBuilderCustomizer> customizerProvider) {
        Serdes.SerdesBuilder builder = Serdes.builder()
                .withDefaults()
    ...
    @ConditionalOnMissingBean
    @Scope(SCOPE_PROTOTYPE)
    public EntityDictionary.EntityDictionaryBuilder entityDictionaryBuilder(Injector injector, ClassScanner scanner,
    ...
    public DataStoreBuilder dataStoreBuilder(JpaDataStoreRegistrationsBuilder builder, ElideConfigProperties settings,
                                             ...
                                             Optional<Cache> optionalCache, Optional<com.paiondata.elide.datastores.aggregation.core.QueryLogger> optionalQueryLogger,
    ...
    /**
     * Creates the default {@link ExceptionMappers.ExceptionMappersBuilder} to create the {@link ExceptionMappers}.
     *
    ...
    @ConditionalOnMissingBean
    @Scope(SCOPE_PROTOTYPE)
    public ExceptionMappers.ExceptionMappersBuilder exceptionMappersBuilder(
        ...
        ExceptionMappers.ExceptionMappersBuilder exceptionMappersBuilder = BasicExceptionMappers.builder();
    ...
    /**
     * Creates the default {@link ExceptionMappers.ExceptionMappersBuilder}.
     *
    ...
    public static class RefreshableConfiguration {
        ...
        @RefreshScope
        @ConditionalOnMissingBean
        public RefreshableElide refreshableElide(ElideSettings.ElideSettingsBuilder elideSettingsBuilder, EntityDictionary dictionary,
    ...
    public static class GraphQLConfiguration {
        ...
        @ConditionalOnMissingBean
        @Scope(SCOPE_PROTOTYPE)
        public GraphQLSettings.GraphQLSettingsBuilder graphqlSettingsBuilder(ElideConfigProperties settings,
    ...
    public static class JsonApiConfiguration {
        ...
        @ConditionalOnMissingBean
        @Scope(SCOPE_PROTOTYPE)
        public JsonApiSettings.JsonApiSettingsBuilder jsonApiSettingsBuilder(ElideConfigProperties settings,
    ...
    public static class AsyncConfiguration {
        ...
        @ConditionalOnMissingBean
        @Scope(SCOPE_PROTOTYPE)
        public AsyncSettings.AsyncSettingsBuilder asyncSettingsBuilder(ElideConfigProperties settings,
    ...
    public static class AggregationStoreConfiguration {
        ...
        @Bean
        @ConditionalOnMissingBean
        public com.paiondata.elide.datastores.aggregation.core.QueryLogger queryLogger() {
            return new Slf4jQueryLogger();
        }
    }

    public static RefreshableElide buildRefreshableElide(ElideSettings.ElideSettingsBuilder elideSettingsBuilder,
    ...
    public static DataStoreBuilder buildDataStoreBuilder(JpaDataStoreRegistrationsBuilder builder,
            ...
            Optional<com.paiondata.elide.datastores.aggregation.core.QueryLogger> optionalQueryLogger,

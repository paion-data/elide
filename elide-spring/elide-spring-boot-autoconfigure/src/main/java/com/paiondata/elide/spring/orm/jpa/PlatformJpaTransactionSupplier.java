 ...
 */
public class PlatformJpaTransactionSupplier implements JpaDataStore.JpaTransactionSupplier {
    ...
    public JpaTransaction get(EntityManager entityManager) {
        return new PlatformJpaTransaction(this.transactionManager,
                this.transactionDefinition, this.entityManagerFactory, entityManager, this.txCancel, JpaDataStore.DEFAULT_LOGGER,

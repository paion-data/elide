...
public interface ElideStandaloneSettings {
    ...
    /**
     * Override this to customize the {@link GraphQLSettings.GraphQLSettingsBuilder}.
     *
     * @param dictionary the dictionary
     * @return the GraphQLSettingsBuilder
     */
    default GraphQLSettings.GraphQLSettingsBuilder getGraphQLSettingsBuilder(EntityDictionary dictionary) {
        return GraphQLSettings.GraphQLSettingsBuilder.withDefaults(dictionary)
    ...
    default DataStore getDataStore(MetaDataStore metaDataStore, AggregationDataStore aggregationDataStore,
        ...
        DataStore jpaDataStore = new JpaDataStore(
                ...
                em -> new NonJtaTransaction(em, TXCANCEL, JpaDataStore.DEFAULT_LOGGER, true, true),
     ...
     * <p>
     * The {@link Paginate#maxPageSize()} annotation
     * takes precendence.
     *
     ...
     * <p>
     * The {@link Paginate#defaultPageSize()} annotation
     * takes precendence.
     *

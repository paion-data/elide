...
class Slf4jExceptionLoggerTest {
    ...
    void forbiddenAccessException() {
        ForbiddenAccessException forbiddenAccessException = Mockito.mock(ForbiddenAccessException.class);
    ...
    void httpStatusException() {
        HttpStatusException httpStatusException = Mockito.mock(HttpStatusException.class);
        Slf4jExceptionLogger logger = new Slf4jExceptionLogger();

...
public class PermissionExpressionBuilder {
    ...
    public FilterExpression buildAnyFieldFilterExpression(
        ...
        if (entityFilter == PermissionToFilterExpressionVisitor.FALSE_USER_CHECK_EXPRESSION
                || entityFilter == PermissionToFilterExpressionVisitor.NO_EVALUATION_EXPRESSION
                || entityFilter == PermissionToFilterExpressionVisitor.TRUE_USER_CHECK_EXPRESSION) {
            entityFilter = null;
        }
        ...
        for (String field : fields) {
            ...
            if (fieldExpression == null || fieldExpression == PermissionToFilterExpressionVisitor.FALSE_USER_CHECK_EXPRESSION) {

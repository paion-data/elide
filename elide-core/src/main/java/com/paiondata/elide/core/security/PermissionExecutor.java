...
public interface PermissionExecutor {
    ...
    default <A extends Annotation> ExpressionResult checkPermission(
            ...
            com.paiondata.elide.core.PersistentResource resource
    ) {
     ...
     * @return the results of evaluating the permission
     */
    <A extends Annotation> ExpressionResult checkSpecificFieldPermissions(com.paiondata.elide.core.PersistentResource<?> resource,
     ...
     * @return the results of evaluating the permission
     */
    <A extends Annotation> ExpressionResult checkSpecificFieldPermissionsDeferred(com.paiondata.elide.core.PersistentResource<?> resource,
                                                                                  ChangeSpec changeSpec,
                                                                                  Class<A> annotationClass,
                                                                                  String field);

...
public class PostfixInsensitivePredicate extends FilterPredicate {
    ...
    public PostfixInsensitivePredicate(Path.PathElement pathElement, List<Object> values) {
        this(new Path(Collections.singletonList(pathElement)), values);
    }

    @SafeVarargs
    public <T> PostfixInsensitivePredicate(Path.PathElement pathElement, T... a) {
